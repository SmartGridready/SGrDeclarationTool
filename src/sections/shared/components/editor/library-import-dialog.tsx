...
import {
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@/sections/shared/components/shadcn/alert-dialog";
import { Input } from "@/sections/shared/components/shadcn/input";
import { Search } from "lucide-react";
import { LibraryItem } from "@/sections/shared/utils/library-api";
...
export function LibraryImportDialog({
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="w-[40vw] max-h-[80vh] flex flex-col">
        <AlertDialogHeader>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={handleConfirm} disabled={!selectedItem || loading}>
            {confirmLabel}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
