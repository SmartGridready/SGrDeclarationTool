...
export const DEVICE_CATEGORY_OPTIONS: {
  ...
  { value: "HeatPumpAppliance", label: "Heat Pump Appliance" },
  ...
  { value: "ElectricityGenerationSystem", label: "Electricity Generation System" },
  ...
  { value: "ChargingStation", label: "Charging Station" },
...
export const POWER_SOURCE_OPTIONS: {
  ...
  { value: "mains1Phase", label: "Mains 1 Phase" },
  { value: "mains3Phase", label: "Mains 3 Phase" },
  { value: "mains1Phase, mains3Phase", label: "Mains 1 Phase or 3 Phase" },
  { value: "battery", label: "Battery" },
  { value: "dc", label: "DC" },
];
...
export const LEVEL_OF_OPERATION_OPTIONS: {
