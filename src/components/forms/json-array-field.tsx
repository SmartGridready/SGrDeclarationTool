    ...
    <div className={`space-y-4 ${className}`}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button type="button" variant="outline" size="sm" onClick={onAddArray} className="flex items-center gap-1">
            <Plus className="h-4 w-4" />
            Add Array
          </Button>
          <Button type="button" variant="outline" size="sm" onClick={onAddElement} className="flex items-center gap-1">
            <Plus className="h-4 w-4" />
            Add Element
          </Button>
        </div>
